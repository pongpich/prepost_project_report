...
import LoGo from "../kelanglogo.png";
                      ...
                      <div className=" grid grid-cols-3 gap-3 " style={{}}>
                        <div className=" col-span-1 parafont">
                          {teststate[0][4].datetime
                            ? <p className=" fontpage">Date of Operation  &emsp;&emsp;{teststate[0][4].textValue.substring(6, 8)}/{teststate[0][4].textValue.substring(4, 6)}/{teststate[0][4].textValue.substring(0, 4)}&emsp; {teststate[0][4].textValue.substring(8, 10)}:{teststate[0][4].textValue.substring(10, 12)}</p>
                      ...
                      <div className=" col-span-6 parafont  pl-1 fontpage">
                        <div className=" grid grid-cols-2">
                          {teststate2[0][1].textValue != ""
                            ?
                            <div className="col-span-1">Date of Operation {teststate2[0][1].textValue.substring(6, 8)}/{teststate2[0][1].textValue.substring(4, 6)}/{teststate2[0][1].textValue.substring(0, 4)}&emsp; {teststate2[0][1].textValue.substring(8, 10)}:{teststate2[0][1].textValue.substring(10, 12)}</div>
